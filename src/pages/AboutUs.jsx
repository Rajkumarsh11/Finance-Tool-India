    ...
    <main className="max-w-7xl mx-auto px-6 py-16 md:py-24">
      ...
      <section className="mb-24">
        <div className="max-w-3xl">
          <span className="label-md uppercase tracking-[0.15em] text-secondary font-bold text-xs mb-4 block">Our Story</span>
      ...
      <section className="grid grid-cols-1 md:grid-cols-12 gap-6 mb-32">
        <div className="md:col-span-8 bg-surface-container-low rounded-[2rem] p-10 md:p-16 flex flex-col justify-end relative overflow-hidden group">
          ...
          <div className="mt-12 flex gap-4 relative z-10">
            ...
            <div className="bg-white/50 backdrop-blur-md p-4 rounded-2xl border border-white/20">
              ...
              <span className="text-xs uppercase tracking-wider text-outline font-semibold">Hidden Biases</span>
            </div>
          </div>
        </div>
        ...
        <div className="md:col-span-4 bg-secondary-container rounded-[2rem] p-10 flex flex-col items-start justify-between group">
          <div className="w-16 h-16 bg-on-secondary-container/10 rounded-2xl flex items-center justify-center mb-8">
            <span className="material-symbols-outlined text-4xl text-on-secondary-container">account_balance</span>
          </div>
          <div>
      ...
      <section className="mt-24 bg-surface-bright border border-outline-variant/20 rounded-[3rem] p-12 md:p-24 text-center">
        ...
        <div className="flex flex-col md:flex-row justify-center gap-6">
          <Link to="/" className="bg-primary text-on-primary px-10 py-4 rounded-xl font-bold hover:shadow-xl transition-all">Explore Tools</Link>
          <Link to="/methodology" className="bg-transparent border-2 border-primary/20 text-primary px-10 py-4 rounded-xl font-bold hover:bg-primary/5 transition-all">Read Methodology</Link>
        </div>
      </section>
    </main>
  );

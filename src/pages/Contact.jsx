    ...
    <main className="min-h-screen">
      ...
      <section className="max-w-7xl mx-auto px-8 pb-24">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
          ...
          <div className="md:col-span-8 bg-surface-container-lowest rounded-xl p-6 md:p-8 lg:p-12 border border-outline-variant/15 shadow-[0px_10px_40px_rgba(7,30,39,0.06)]">
            ...
            <form action="#" className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <input className="w-full px-4 py-3 bg-surface-container-low border-0 focus:ring-2 focus:ring-primary rounded-xl placeholder:text-outline transition-all" placeholder="John Doe" type="text" />
                </div>
                <div className="space-y-2">
                  <label className="text-xs font-bold uppercase tracking-widest text-on-surface-variant ml-1">Email Address</label>
                  <input className="w-full px-4 py-3 bg-surface-container-low border-0 focus:ring-2 focus:ring-primary rounded-xl placeholder:text-outline transition-all" placeholder="john@example.com" type="email" />
                </div>
              </div>
              <div className="space-y-2">
              ...
              <div className="space-y-2">
                ...
                <textarea className="w-full px-4 py-3 bg-surface-container-low border-0 focus:ring-2 focus:ring-primary rounded-xl placeholder:text-outline transition-all resize-none" placeholder="How can we assist you today?" rows="5"></textarea>
              </div>
              <div className="pt-4">
                <button className="w-full md:w-auto bg-gradient-to-r from-primary to-primary-container text-on-primary px-10 py-4 rounded-xl font-bold text-lg shadow-lg hover:shadow-xl transition-all transform hover:-translate-y-0.5" type="button">
                  Send Message
                </button>
              </div>
            </form>
          ...
          <div className="md:col-span-4 space-y-6">
            {/* Quick Contact Info */}
            <div className="bg-surface-container-low rounded-xl p-6 md:p-8 border border-outline-variant/15">
            ...
            <div className="bg-primary text-on-primary rounded-xl p-6 md:p-8 relative overflow-hidden group">
              ...
              <Link to="/help" className="inline-flex items-center gap-2 font-bold hover:gap-3 transition-all relative z-10 text-secondary-fixed">
      ...
      <section className="max-w-7xl mx-auto px-8 pb-24">
        <div className="bg-surface-container rounded-xl overflow-hidden h-96 relative">
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="bg-white/70 backdrop-blur-md p-6 rounded-xl border border-white/20 shadow-2xl text-center max-w-xs transition-all">
